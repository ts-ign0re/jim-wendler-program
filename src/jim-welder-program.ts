...
const JimWelderProgramLoad = [week1, week2, week3, week4];

const use90PercentAsDefaultMaxWeight = (maxWeight: number) => roundToFive(Math.round(maxWeight * 0.9));

export const JimWelderProgram = (maxWeight: number) => defaultProgram(use90PercentAsDefaultMaxWeight(maxWeight), JimWelderProgramLoad);